...
<div class="container">
	...
	<div class="row">
		...
		<div class="intro-sm-10 text-center border border-primary">

			<br>Bu websitesi hiç bir maddi amaç gütmemektedir. Eğitim ve araştırma amaçlı kullanılacaktır.<br><br>
			Aşağıdaki başlat butonuna tıklayarak ders kategorilerini görebilir, ve seçeceğiniz kategoride konu başlıklarını görüntüleyebilirsiniz.
				...
				<g fill="none">
					<g transform="translate(2.000000, 2.000000)" stroke-width="4">
						...
						<path
							...
							id="triangle" stroke="#34495e"></path>
						<path
